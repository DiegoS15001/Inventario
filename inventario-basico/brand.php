		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title"><i class="fa fa-plus"></i> Añadir nueva marca</h4>
				...
				<div class="modal-body">
					<form method="post" id="brandForm">
						...
						<div class="mb-3">
							<label>Ingresa nueva marca</label>
							<input type="text" name="bname" id="bname" class="form-control  rounde-0" required />
						</div>
					</form>
				</div>
				<div class="modal-footer">
					<input type="submit" name="action" id="action" class="btn btn-primary btn-sm rounded-0" value="Añadir" form="brandForm" />
					<button type="button" class="btn btn-default btn-sm rounded-0" data-bs-dismiss="modal">Cancelar</button>
				</div>
			</div>
		</div>
	</div>
